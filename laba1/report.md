...
![Загрузка файлов](image/Screenshot_11.png){ #fig:005 width=70% height=70% }
![Файлы на Github](image/Screenshot_12.png){ #fig:005 width=70% height=70% }

Использование системы управления версиями. Создаем ветку, начинаем и завершаем в ней релиз.

![Инициализация git-flow и начало релиза](image/Screenshot_13.png){ #fig:006 width=70% height=70% }

![Завершение релиза и отправка изменений в сетевой репозиторий](image/Screenshot_14.png){ #fig:007 width=70% height=70% }
![Завершение релиза и отправка изменений в сетевой репозиторий](image/Screenshot_15.png){ #fig:007 width=70% height=70% }

Объединяем ветки

![Объединяем ветки](image/Screenshot_16.png){ #fig:007 width=70% height=70% }
# Вывод
